...
(function(){
  "use strict";
  // Valores reais injetados pelo layout via window.ACB_BIZ (fonte: src/data/empresa.ts).
  // waNumber é placeholder [CONFIRMAR] até o cliente validar o WhatsApp real.
